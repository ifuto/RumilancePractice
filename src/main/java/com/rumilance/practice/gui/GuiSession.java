...
public final class GuiSession {
    ...
    /** True while switching to another practice GUI so Esc-return must not bounce to Game Menu. */
    private volatile boolean navigatingAway;
    ...
    public void setNavigatingAway(boolean navigatingAway) {
        this.navigatingAway = navigatingAway;
    }

    public boolean consumeNavigatingAway() {
        boolean value = navigatingAway;
