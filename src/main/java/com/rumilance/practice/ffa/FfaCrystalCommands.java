...
public final class FfaCrystalCommands implements CommandExecutor, TabCompleter {
    ...
    private com.rumilance.practice.gui.menus.CrystalKitQuickGui crystalKitQuickGui;

    public FfaCrystalCommands(FfaService ffaService) {
        this.ffaService = ffaService;
    }

    /** Wired from bootstrap; {@code /k} opens this picker. */
    public void setCrystalKitQuickGui(
            com.rumilance.practice.gui.menus.CrystalKitQuickGui crystalKitQuickGui) {
        this.crystalKitQuickGui = crystalKitQuickGui;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        switch (name) {
            ...
            case "k" -> {
                if (crystalKitQuickGui != null) {
                    crystalKitQuickGui.open(player);
                }
            }
            default -> {
