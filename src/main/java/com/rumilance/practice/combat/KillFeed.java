...
/**
 * Global kill line: {@code ⚔ killer → victim [♡current/max]}. Names are clickable and open
 * the stored end-of-match inventories for that duel when a {@code matchId} is provided.
 */
public final class KillFeed {
    ...
    public static Component line(Player killer, Player victim,
        ...
        return Component.text("⚔ ", NamedTextColor.WHITE)
                ...
                .append(Component.text(formatHp(killerHealth), NamedTextColor.WHITE))
                .append(Component.text("/", NamedTextColor.GRAY))
                .append(Component.text(formatHp(killerMax), NamedTextColor.WHITE))
                .append(Component.text("]", NamedTextColor.DARK_GRAY));
    }
