...
public final class DeathBridge implements Listener {
    ...
    public void onDeath(PlayerDeathEvent event) {
        ...
        // Revive at one heart. Paper's default is MAX health, which flashed every planned
        // death as a full heal ("致命傷で体力MAXに戻る"); the mode ruling re-applies the
        // real loadout/health right after, so one heart is always the honest starting point.
