...
execute at @e[tag=rtp,type=marker] run execute positioned ~ ~10 ~ run spreadplayers ~ ~ 15 15 false @a[tag=xlib_bot]
execute as @a[tag=xlib_bot] at @s positioned over world_surface run tp @s ~ ~10 ~
tp @s @s
