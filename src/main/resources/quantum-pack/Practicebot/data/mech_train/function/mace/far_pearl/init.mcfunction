...
execute as @a[tag=xlib_bot] at @s run function mech_train:mace/far_pearl/loop
attribute @a[tag=xlib_bot] gravity base set 0
attribute @a[tag=xlib_bot] max_health base set 2