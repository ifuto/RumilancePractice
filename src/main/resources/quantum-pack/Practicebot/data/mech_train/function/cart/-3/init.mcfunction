scoreboard players set .mode mode 601
title @a times 2 5 2
...
execute as @a[tag=xlib_target] at @s positioned over world_surface run tp @s ~ ~ ~ facing ~ ~-3 ~3
...
execute as @a[tag=xlib_bot] at @s run function mech_train:cart/-3/loop