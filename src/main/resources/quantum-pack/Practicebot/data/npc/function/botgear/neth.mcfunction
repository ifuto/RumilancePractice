...
item replace entity @s armor.legs with minecraft:netherite_leggings[minecraft:enchantments={"protection":4},minecraft:unbreakable={}]
...
execute if score .blast_prot npc matches 1 run item replace entity @s armor.legs with minecraft:netherite_leggings[minecraft:enchantments={"blast_protection":4},minecraft:unbreakable={}]
execute if score .blast_prot npc matches 2 run item replace entity @s armor.legs with minecraft:netherite_leggings[minecraft:enchantments={"minecraft:blast_protection":4},minecraft:unbreakable={}]
execute if score .blast_prot npc matches 2 run item replace entity @s armor.feet with minecraft:netherite_boots[minecraft:enchantments={"minecraft:feather_falling":4,"minecraft:blast_protection":4},minecraft:unbreakable={}]
...
scoreboard players set .botgear npc 1
