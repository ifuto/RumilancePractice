...
function npc:settings/on/insta_shieldcd
...
title @a actionbar [{"text":"Mace Preset ", "color": "yellow"},{"text":"ON!","color": "green"}]
...
execute if score @s kit matches 10 positioned -625 31 89 run return run function quantum:kits/kit10
execute if score @s kit matches 11 positioned -625 31 90 run return run function quantum:kits/kit11
execute if score @s kit matches 12 positioned -625 31 91 run return run function quantum:kits/kit12