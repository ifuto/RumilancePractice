...
item replace entity @s armor.head with minecraft:diamond_helmet[minecraft:enchantments={"minecraft:protection":4,"unbreaking":3},minecraft:unbreakable={}] 1
item replace entity @s armor.chest with minecraft:diamond_chestplate[minecraft:enchantments={"minecraft:protection":4,"unbreaking":3},minecraft:unbreakable={}]
item replace entity @s armor.legs with minecraft:diamond_leggings[minecraft:enchantments={"minecraft:blast_protection":4,"unbreaking":3,"minecraft:protection":4},minecraft:unbreakable={}]
execute if score .mode mode matches 2 run item replace entity @s armor.legs with minecraft:diamond_leggings[minecraft:enchantments={"minecraft:blast_protection":4,"unbreaking":3},minecraft:unbreakable={}]
execute if score .mode mode matches 3 run item replace entity @s armor.legs with minecraft:diamond_leggings[minecraft:enchantments={"minecraft:protection":4,"unbreaking":3},minecraft:unbreakable={}]
execute if score .mode mode matches 6 run item replace entity @s armor.legs with minecraft:diamond_leggings[minecraft:enchantments={"minecraft:blast_protection":4,"unbreaking":3},minecraft:unbreakable={}]
item replace entity @s armor.feet with minecraft:diamond_boots[minecraft:enchantments={"minecraft:feather_falling":4,"minecraft:protection":4,"unbreaking":3},minecraft:unbreakable={}]
execute if score .mode mode matches 2 if score .dbp toggles matches 1 if score .old_kb toggles matches 0 run item replace entity @s armor.feet with minecraft:diamond_boots[minecraft:enchantments={"minecraft:feather_falling":4,"minecraft:blast_protection":4,"unbreaking":3},minecraft:unbreakable={}]

item replace entity @s hotbar.0 with totem_of_undying[enchantments={knockback:1}]
execute if score .mode mode matches 3 if score .spear toggles matches 1 run item replace entity @s hotbar.0 with diamond_spear[enchantments={lunge:3,unbreaking:3,sharpness:5},unbreakable={}]
...
execute if score .mode mode matches 6 if score .difficulty difficulty matches 6 run item replace entity @s hotbar.0 with bow[minecraft:enchantments={infinity:1,power:255,punch:10,flame:10,multishot:10,piercing:10,riptide:5,infinity:1,channeling:1}]

item replace entity @s hotbar.1 with wind_charge[max_stack_size=99] 99
execute if score .mode mode matches 2 run item replace entity @s hotbar.1 with minecraft:obsidian[enchantments={knockback:1}] 64
...
item replace entity @s hotbar.3 with diamond_sword[enchantments={sweeping_edge:3,sharpness:5},unbreakable={}]
execute if score .mode mode matches 2 run item replace entity @s hotbar.3 with minecraft:diamond_sword[minecraft:enchantments={"minecraft:sharpness":5,"minecraft:knockback":1},minecraft:unbreakable={}]
execute if score .mode mode matches 6 run item replace entity @s hotbar.3 with diamond_sword[enchantments={sweeping_edge:3,sharpness:5,knockback:1},unbreakable={}]

item replace entity @s hotbar.4 with minecraft:golden_apple 64
execute if score .shield toggles matches 1 if score .mode mode matches 2 run item replace entity @s hotbar.4 with minecraft:shield[unbreakable={},enchantment_glint_override=true]

item replace entity @s hotbar.5 with minecraft:diamond_axe[minecraft:enchantments={"sharpness":5},minecraft:unbreakable={}]
...
item replace entity @s inventory.5 with water_bucket
...
data modify entity @n[type=item_display,name="Netherite gear"] CustomName set value {"text":"Netherite gear","color": "#ff0000"}
data modify entity @n[type=item_display,name="Diamond gear"] CustomName set value {"text":"Diamond gear","color": "#00ff00"}
