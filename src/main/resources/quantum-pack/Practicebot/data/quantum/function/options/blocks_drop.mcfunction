execute unless score .blocks_drop toggles matches 1 as @e[type=item_display,name="Blocks Drop"] run data modify entity @s CustomName set value {"text":"Blocks Drop","color": "#00ff00"}
