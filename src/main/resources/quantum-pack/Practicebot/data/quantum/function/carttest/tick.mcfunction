execute if score .cart_speed toggles matches 1 unless score @s bowcharge matches 1.. at @s at @p[tag=xlib_target] run function quantum:carttest/speed/pre_cart
execute if score .cart_speed toggles matches 2 unless score @s bowcharge matches 1.. at @s at @p[tag=xlib_target] run function quantum:carttest/speed/pre_rail
execute if score .cart_speed toggles matches 3 unless score @s bowcharge matches 1.. at @s at @p[tag=xlib_target] run function quantum:carttest/speed/insta
...
execute at @p[tag=xlib_target,distance=..6] unless score @p[tag=xlib_target] in_cobweb_decision matches 1 unless score @s hit_decision_without_cd matches 1 run function quantum:carttest/mark/tick
