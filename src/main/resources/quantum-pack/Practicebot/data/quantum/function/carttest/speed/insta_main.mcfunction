...
execute at @n[tag=rail_1,distance=0..,type=marker] unless entity @e[tag=rail_2,distance=0..,type=marker] unless entity @e[tag=rail_3,distance=0..,type=tnt_minecart] run function quantum:cart/charge
...
execute as @n[tag=rail_1,distance=0..,type=marker] unless entity @e[tag=rail_2,distance=0..,type=marker] unless entity @e[tag=rail_3,distance=0..,type=tnt_minecart] run tag @s add spot
