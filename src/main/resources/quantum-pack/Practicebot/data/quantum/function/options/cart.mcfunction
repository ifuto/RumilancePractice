scoreboard players set .mode mode 6
title @a actionbar [{"text":"TNT MINECART","color": "gold"},{"text":" ON!", "color":"#00ff00"}]
tellraw @a [{"text":"TNT MINECART","color": "gold"},{"text":" ON!", "color":"#00ff00"}]
